...
public class Emarsys {
	...
	public static void main(String[] args) throws Exception {
       Emarsys Emarsys = new Emarsys("https://api.emarsys.net/", "blanja003", "idajWJRjQ5Vhoa86YmTn");
       Emarsys.send("GET", "language", null);
//       Emarsys.send("POST", "source/create", "{\\"name\\":\\"RANDOM\\"}");
   }

	public Emarsys(String environment, String apiUsername, String apiSecretKey) {
...
//           "UsernameToken Username=\\"+apiUsername+"\\", PasswordDigest=\\"%s\\", Nonce=\\"%s\\", Created=\\"%s\\"", apiUsername, digest, nonce, timestamp);
       return null;
   }
